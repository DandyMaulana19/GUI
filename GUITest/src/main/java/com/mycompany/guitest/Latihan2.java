...
public class Latihan2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Indomie :");

        jLabel4.setText("Kornet :");

        jLabel5.setText("Telur :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            int totalbeli = ((indomie * a) + (telur * b) + (kornet * c));
            int totalbulat = (totalbeli / 1000) * 1000 - totalbeli;

            JOptionPane.showMessageDialog(null, "Total Pembelian: " + totalbeli + "\n Jumlah Pembulatan: " + totalbulat + "\n Total Bayar: " + totalbeli);
